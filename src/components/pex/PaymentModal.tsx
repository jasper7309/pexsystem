...
export function BankTransferModal({
  ...
  const bt = plan.bankTransfer!;

  return (
    <ModalShell plan={plan} onClose={onClose} title="Bank transfer details">
      <div className="mt-6 space-y-5">
        <div className="grid grid-cols-2 gap-3">
          <div className="rounded-xl border border-border bg-accent/40 p-3">
            ...
            <p className="type-h3 mt-1 text-foreground">{bt.price}</p>
          </div>
          <div className="rounded-xl border border-border bg-accent/40 p-3">
            <p className="type-meta text-muted-foreground">Bank Name</p>
            <p className="type-h3 mt-1 text-foreground">{bt.bankName}</p>
          </div>
          <div className="col-span-2 rounded-xl border border-border bg-accent/40 p-3">
            <p className="type-meta text-muted-foreground">Account Name</p>
            <p className="type-h3 mt-1 text-foreground">{bt.accountName}</p>
          </div>
        </div>

        <div className="rounded-xl border border-border bg-accent/40 p-4">
          <p className="type-meta text-muted-foreground">Account Number</p>
          <div className="mt-2 flex items-center justify-between gap-3">
            <p className="type-h3 text-foreground tracking-widest">{bt.accountNumber}</p>
            <CopyAddress address={bt.accountNumber} />
          </div>
        </div>
